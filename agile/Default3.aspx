...
<body>
 <!--<img alt="" id="id2"  src="3d-star-hi.png" style="height: 103px; width: 107px; margin-top:15px;  margin-left: 200px;margin-bottom:50px;"/> -->
  ...
  <!--   <img id="id1" alt="" src="party_balloons-27.png" style="height: 300px; width: 300px; margin-top:70px;" onclick="return id1_onclick() "  />-->
      ...
      <div class="class1">
    <p>
        <label id="lbl" style=" margin-left: 30px; width: 99px;" >10</label>
        <label id="lbl3" style="height: 99px; margin-left: 30px; width: 99px;  margin-top:90px;margin-bottom:90px;" >+</label>
        <label id="lbl2" style="height: 99px; margin-left: 30px; width: 99px;" >12</label>
    
    <p>
        <input id="Button1" type="button" value="25" onclick="return Button1_onclick()" style="margin-top:70px;" />&nbsp;
        <input id="Button2" type="button" value="23" onclick="return Button2_onclick()" />
        <input id="Button3" type="button" value="22" onclick="return Button3_onclick()" />
        <input id="Button4" type="button" value="26" onclick="return Button4_onclick()" /></p>
...
// <!CDATA[
            ...
            function Button4_onclick() {
                ...
                if (count == 4) {
                    ...
                    if (score >= 3) {
                        ...
                        window.location = "Default5.aspx?" + score;
            ...
            function Q2() {
                ...
                document.getElementById("Button1").value = "27";
                document.getElementById("Button2").value = "17";
                document.getElementById("Button3").value = "19";
                document.getElementById("Button4").value = "25";
            ...
            function Q3() {
                ...
                document.getElementById("lbl").innerHTML = "19";
                document.getElementById("lbl2").innerHTML = "2";
                document.getElementById("Button1").value = "21";
                document.getElementById("Button2").value = "28";
            ...
            function Q4() {
                count += 1;
                document.getElementById("lbl").innerHTML = "21";
                document.getElementById("lbl2").innerHTML = "8";
                document.getElementById("Button1").value = "24";
                document.getElementById("Button2").value = "30";
                document.getElementById("Button3").value = "29";
                document.getElementById("Button4").value = "31";

                return;
            }
            function Q5() {
                count += 1;
                document.getElementById("lbl").innerHTML = "50";
                document.getElementById("lbl2").innerHTML = "10";
                document.getElementById("Button1").value = "80";
                document.getElementById("Button2").value = "62";
                document.getElementById("Button3").value = "70";
                document.getElementById("Button4").value = "60";
