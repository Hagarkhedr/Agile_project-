 ...
 <!--<img alt="" id="id2"  src="3d-star-hi.png" style="height: 103px; width: 107px; margin-top:15px;  margin-left: 200px;margin-bottom:50px;"/> -->
  ...
  <!--   <img id="id1" alt="" src="party_balloons-27.png" style="height: 300px; width: 300px; margin-top:70px;" onclick="return id1_onclick() "  />-->
    ...
    <p>
        ...
        <label id="lbl2" style="height: 99px; margin-left: 30px; width: 99px;" >1</label>
    
    <p>
        <input id="Button1" type="button" value="4" onclick="return Button1_onclick()" style="margin-top:70px;" />&nbsp;
        ...
        <input id="Button4" type="button" value="2" onclick="return Button4_onclick()" /></p>
...
// <!CDATA[
             ...
             function Button4_onclick() {
                ...
                (count == 4) {
                     ...
                     document.getElementById("Img16").setAttribute("src", "rating-star-256.png");
                         rightanswer("Img16");
                         if (score >= 3) {
                             window.location.href = "Default2.aspx?" + score;
             ...
             function f1() {
                 ...
                 window.location.href = "Default4.aspx?" + score;
             ...
             function Q4() {
                 ...
                 document.getElementById("Button2").value = "7";
                 document.getElementById("Button3").value = "11";
                 document.getElementById("Button4").value = "8";
             ...
             function Q5() {
                 ...
                 document.getElementById("Button1").value = "9";
                 document.getElementById("Button2").value = "12";
                 document.getElementById("Button3").value = "10";
                 document.getElementById("Button4").value = "17";
