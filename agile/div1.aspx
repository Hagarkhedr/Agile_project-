<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="div1.aspx.cs" Inherits="_Default" %>
...
<label id="lbl2"style="height: 99px; margin-left: 30px; width: 99px;">8</label></p>

<p>
<input id="Button1"type="button"value="6"onclick="return Button1_onclick()"style="margin-top:70px;"/>&nbsp;
<input id="Button2"type="button"value="5"onclick="return Button2_onclick()"/>
<input id="Button3"type="button"value="2"onclick="return Button3_onclick()"/>
<input id="Button4"type="button"value="10"onclick="return Button4_onclick()"/></p>
...
// <!CDATA[
        ...
        function Button4_onclick() {
            ...
            if (count == 4) {
                ...
                if (score >= 3) {
                    window.location = "div1_comp.aspx?" + score;
        ...
        function f1() {
            ...
            window.location = "div1_failed.aspx";

        }
        function Q2() {
            count += 1;
            document.getElementById("lbl").innerHTML = "3";
            document.getElementById("lbl2").innerHTML = "3";
        ...
        function Q3() {
            ...
            document.getElementById("lbl2").innerHTML = "4";
            document.getElementById("Button1").value = "2";
            document.getElementById("Button2").value = "0";
            document.getElementById("Button3").value = "7";
        ...
        function Q4() {
            ...
            document.getElementById("Button2").value = "11";
        ...
        function Q5() {
            count += 1;
            document.getElementById("lbl").innerHTML = "3";
            document.getElementById("lbl2").innerHTML = "9";
