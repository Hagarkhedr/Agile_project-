...
<body>
 <!--<img alt="" id="id2"  src="3d-star-hi.png" style="height: 103px; width: 107px; margin-top:15px;  margin-left: 200px;margin-bottom:50px;"/> -->
  ...
  <!--   <img id="id1" alt="" src="party_balloons-27.png" style="height: 300px; width: 300px; margin-top:70px;" onclick="return id1_onclick() "  />-->
      ...
      <div class="class1">
    <p>
        <label id="lbl" style=" margin-left: 30px; width: 99px;" >72</label>
    ...
    <p>
        <input id="Button1" type="button" value="86" onclick="return Button1_onclick()" style="margin-top:70px;" />&nbsp;
        <input id="Button2" type="button" value="84" onclick="return Button2_onclick()" />
        <input id="Button3" type="button" value="82" onclick="return Button3_onclick()" />
        <input id="Button4" type="button" value="76" onclick="return Button4_onclick()" /></p>
...
// <!CDATA[
            ...
            function Button4_onclick() {
                ...
                if (count == 4) {
                    ...
                    if (score >= 3) {
                        window.location = "3_comp.aspx?" + score;
            ...
            function f1() {
                ...
                window.location = "3_failed.aspx";

            }
            function Q2() {
                count += 1;
                document.getElementById("lbl").innerHTML = "95";
                document.getElementById("lbl2").innerHTML = "2";
                document.getElementById("Button1").value = "97";
            ...
            function Q3() {
                ...
                document.getElementById("lbl2").innerHTML = "5";
                document.getElementById("Button1").value = "103";
                document.getElementById("Button2").value = "105";
                document.getElementById("Button3").value = "110";
                document.getElementById("Button4").value = "107";
                return;
            }
            function Q4() {
                count += 1;
                document.getElementById("lbl").innerHTML = "112";
                document.getElementById("lbl2").innerHTML = "8";
                document.getElementById("Button1").value = "124";
                document.getElementById("Button2").value = "130";
                document.getElementById("Button3").value = "120";
                document.getElementById("Button4").value = "131";
            ...
            function Q5() {
                ...
                document.getElementById("lbl2").innerHTML = "27";
                ...
                document.getElementById("Button4").value = "177";
