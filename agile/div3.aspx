<%@ Page Language="C#" AutoEventWireup="true" CodeFile="div3.aspx.cs" Inherits="div3" %>
...
<img alt=""id="Img17"src="yellow-star-md.png"style="height: 103px; width: 107px; margin-top:15px;  margin-left: 400px;margin-bottom:50px;"/>
    ...
    <div class="class1">
<p>
<label id="lbl"style=" margin-left: 30px; width: 99px;">3</label>
<label id="lbl3"style="height: 99px; margin-left: 30px; width: 99px;  margin-top:90px;margin-bottom:90px;">/</label>
<label id="lbl2"style="height: 99px; margin-left: 30px; width: 99px;">600</label>

<p>
<input id="Button1"type="button"value="460"onclick="return Button1_onclick()"style="margin-top:70px;"/>&nbsp;
<input id="Button2"type="button"value="200"onclick="return Button2_onclick()"/>
<input id="Button3"type="button"value="608"onclick="return Button3_onclick()"/>
<input id="Button4"type="button"value="677"onclick="return Button4_onclick()"/></p>
...
// <!CDATA[
        ...
        function Button4_onclick() {
            ...
            if (count == 4) {
                ...
                if (score >= 3) {
                    window.location = "div3_comp.aspx?" + score;
        ...
        function f1() {
            ...
            window.location = "div3_failed.aspx";

        }
        function Q2() {
            count += 1;
            document.getElementById("lbl").innerHTML = "5";
            document.getElementById("lbl2").innerHTML = "125";
            document.getElementById("Button1").value = "25";
            document.getElementById("Button2").value = "100";
            document.getElementById("Button3").value = "90";
            document.getElementById("Button4").value = "56";
        ...
        function Q3() {
            ...
            document.getElementById("lbl").innerHTML = "100";
            document.getElementById("lbl2").innerHTML = "300";
            document.getElementById("Button1").value = "133";
            document.getElementById("Button2").value = "3";
            document.getElementById("Button3").value = "10";
            document.getElementById("Button4").value = "39";
            return;
        }
        function Q4() {
            count += 1;
            document.getElementById("lbl").innerHTML = "2";
            document.getElementById("lbl2").innerHTML = "150";
            document.getElementById("Button1").value = "330";
            document.getElementById("Button2").value = "590";
            document.getElementById("Button3").value = "75";
            document.getElementById("Button4").value = "910";
        ...
        function Q5() {
            ...
            document.getElementById("Button1").value = "372";
            document.getElementById("Button2").value = "261";
            document.getElementById("Button3").value = "972";
            document.getElementById("Button4").value = "50";
